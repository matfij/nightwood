...
export const CARRAMBA_SANDS: ExpeditionDto = {
    ...
    goldAward: 100,
    loots: [
        BUBULAE_STEAK, BUBULAE_STEAK, BUBULAE_STEAK, BUBULAE_STEAK, BUBULAE_STEAK, BUBULAE_STEAK, 
        IHON_BERRY, IHON_BERRY, IHON_BERRY, IHON_BERRY,
        RELIQUM_EGG, RELIQUM_EGG, RELIQUM_EGG, RELIQUM_EGG, RELIQUM_EGG, RELIQUM_EGG,
        SPIRAL_NUT, SPIRAL_NUT, SPIRAL_NUT, SPIRAL_NUT, SPIRAL_NUT,
...
export const HARNA_PEAKS: ExpeditionDto = {
    ...
    goldAward: 125,
    loots: [
        BUBULAE_STEAK, BUBULAE_STEAK, BUBULAE_STEAK, BUBULAE_STEAK, BUBULAE_STEAK, 
        IHON_BERRY, IHON_BERRY, IHON_BERRY, IHON_BERRY,
