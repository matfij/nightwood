...
import { ARTICHOKE, CRIMSON_SEED, ETERNAL_FLOWER, FEEBLE_MUSHROOMS, FILIKO_ROOTS, GATE_KEY, GATE_PARTICLE, MIDNIGHT_ESSENCE, PALE_GRAINS, SHARD_AGILITY, SHARD_ATTACK, SHARD_BLANK, SHARD_DEFENCE, SHARD_UNITY, SHARD_WISDOM, SOVAGA_LEAVES, SUPERCHARGED_CRYSTAL, TRANSMUTATION_STONE } from "src/api/items/item/model/data/ingredients";
...
export const MIRAGE_ISLANDS: ExpeditionDto = {
    ...
    extraLoots: [
        ...
        BUBULAE_STEAK, IHON_BERRY, RELIQUM_EGG, SPIRAL_NUT, RORIS_LEAVES,
        SHARD_UNITY,
        GATE_PARTICLE, GATE_PARTICLE, GATE_PARTICLE, GATE_PARTICLE, GATE_PARTICLE,
        GATE_KEY, GATE_KEY,
        CRIMSON_SEED,
    ],
