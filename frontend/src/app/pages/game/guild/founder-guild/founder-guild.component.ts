...
export class FounderGuildComponent {
  ...
  addRoleForm = new FormGroup({
    name: new FormControl<string | null>(null, [
      Validators.required,
      Validators.minLength(GUILD_ROLE_NAME_MIN_LENGTH),
      Validators.maxLength(GUILD_ROLE_NAME_MAX_LENGTH),
    ]),
    priority: new FormControl<number | null>(null, [
      Validators.required,
      Validators.min(GUILD_ROLE_PRIORITY_MIN),
      Validators.max(GUILD_ROLE_PRIORITY_MAX),
    ]),
  ...
  addRoleFormFields: FormInputOptions[] = [
    { form: this.addRoleForm, key: 'name', label: 'guild.name', type: 'text' },
    {
      ...
      key: 'priority',
      label: 'guild.priority',
      type: 'number',
    },
    {
      form: this.addRoleForm,
      key: 'canAddMembers',
      label: 'guild.canAddMembers',
      fieldType: FieldType.CHECKBOX,
    },
    {
      form: this.addRoleForm,
      key: 'canRemoveMembers',
      label: 'guild.canRemoveMembers',
      fieldType: FieldType.CHECKBOX,
    },
    {
      form: this.addRoleForm,
      key: 'canConstruct',
      label: 'guild.canConstruct',
      fieldType: FieldType.CHECKBOX,
    },
  ];
